...
- [x] Password reset preserves TASK-00007 generic and redacted failures, one-time replay and expiry rejection,
...
- [x] Tests prove race losers and stale callbacks are mutation-free, failed Units of Work roll back grant and
  delivery state together, and all TASK-00007 observable behavior remains unchanged.
