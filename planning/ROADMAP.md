...
| --- | --- | --- | --- |
| [EPIC-00002](epics/00002-EPIC.md) | 0.x | in-progress | Agent HMAC authentication, operator-safe Agent identification, direct authority, and unified current-authority access are split into T-00019 through T-00025; T-00019 and T-00025 are complete. |

## Route to 0.x

1. Implement [T-00020](tickets/00020-TICKET.md) and [T-00021](tickets/00021-TICKET.md), then the recorded Agent
   HMAC blocking edges.
