...
|---|---|---|---|
| [Agent HMAC authentication and direct authority](agent-hmac-authentication-map.md) | Active | [WF-004](tickets/WF-004-agent-principal-resolution-conformance.md) | Pending |
