...
|---|---|---|---|
| [Enforce permission grant tiers for v0.4.0](permission-grant-tiers-v0-4-0-map.md) | Active | [Atomic enforcement and integration proof](tickets/WF-016-atomic-enforcement-and-proof.md) | — |
