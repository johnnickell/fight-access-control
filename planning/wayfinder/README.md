...
|---|---|---|---|
| [Agent HMAC authentication and direct authority](agent-hmac-authentication-map.md) | Active | [WF-003](tickets/WF-003-agent-permission-reference-integrity.md) | Pending |
