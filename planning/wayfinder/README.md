...
|---|---|---|---|
| [Enforce permission grant tiers for v0.4.0](permission-grant-tiers-v0-4-0-map.md) | Active | [Historical forbidden authority](tickets/WF-015-forbidden-authority-remediation.md) | — |
