...
Resolve work from the canonical file in `planning/tasks/`, never from an inferred Ticket or GitHub number. Before
...
Keep the ticket, board, Ticket, epic, and roadmap synchronized. A ticket becomes `done` only after acceptance
