...
- Fight AccessControl creates access-JWT material through Fight Common security ports. The five starter
  repositories provide implementation evidence through their consumer-owned clients, transports, persistence,
  key configuration, mail, queues, and runtime composition while all apply the same conformance outcomes.
